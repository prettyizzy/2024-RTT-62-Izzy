...
public class Homework303_2_1 {
    ...
    public static void divisionOfDouble() {
        ...
        System.out.print("The quotient of " + num1 + " and " + num2 + " is " + quotientDouble);

        // Now, cast the result to an integer. Print out the result again.
        int quotientInt = (int) quotientDouble;
        System.out.print("The quotient of " + num1 + " and " + num2 + " as an integer is " + quotientInt);
    ...
    public static void myCafe() {
        ...
        // and complete an “order” for three items of the first product, four items of the second product, and two items of the third product.
        System.out.println("""
                |  ----  ORDER RECEIPT ----  |
